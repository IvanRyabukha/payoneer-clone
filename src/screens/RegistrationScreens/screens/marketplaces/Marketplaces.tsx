...
import { useDebounce } from '@/screens/shared/hooks/useDebounce';
  ...
  const goToSetup = () => {
    ...
    const rootNav =
      navigation.getParent<
        NativeStackNavigationProp<RegistrationStackParamList>
      >();
    rootNav?.navigate('RegistrationHiddenStack');
  };
